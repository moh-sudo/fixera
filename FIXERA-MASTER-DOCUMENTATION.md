...
- **Not yet redesigned** (still old SB-Admin-2/emoji style): RevenueForecast, PartnerAvailability, and **Dispatch** (~566 lines — the single largest remaining section, not yet started).
